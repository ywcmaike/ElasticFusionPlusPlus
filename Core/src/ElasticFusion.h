...
#include "Utils/MyFrame.h"
#include "Utils/PnpSolver.h"
...
//                                  cv::Mat nextRGB, cv::Mat nextDepth, cv::Mat nextDescriptor, std::vector<cv::KeyPoint> nextKeyPoint
         ...
         * @return
         */
        EFUSION_API MyFrame & getFirstMyFrame();
        /**
         *
         * @return
         */
        EFUSION_API MyFrame & getNextMyFrame();
        /**
         *
         * @param rgb
         * @param depth
         * @param myFrame
         */
        EFUSION_API void setMyFrame(unsigned char* rgb, unsigned short* depth, MyFrame& myFrame);

        /**
         * add by yeweicai, yeweicai@sensetime.com
         * @param MyFram fistMyFrame,
         * @param MyFram nextMyFrame,
         * @ouput initRotation R, initTranslation t, Bool initRt
         */
        EFUSION_API void computeRotationAndTranslation(MyFrame& fistMyFrame, MyFrame& nextMyFrame, Eigen::Matrix<float, 3, 3, Eigen::RowMajor> & initRot,
         ...
         */
        EFUSION_API void processFrame(Eigen::Matrix<float, 3, 3, Eigen::RowMajor> & initRot,
                                      Eigen::Vector3f & initTrans, bool initRt,
...
//    cv::Mat firstRGB, firstDepth, firstDescriptor;
//    std::vector<cv::KeyPoint> firstKeyPoint;
//    cv::Mat nextRGB, nextDepth, nextDescriptor;
//    std::vector<cv::KeyPoint> nextKeyPoint;
};
